...
(function () {
  ...
  function injectCSS(color) {
    ...
    var css = [
      ...
      '.cb-body{max-width:90%;display:flex;flex-direction:column;gap:4px}',
      '.cb-m.u .cb-body{align-items:flex-end}',
      '.cb-bubble{padding:16px 20px;border-radius:18px;font-size:15px;line-height:1.7;word-break:break-word}',
