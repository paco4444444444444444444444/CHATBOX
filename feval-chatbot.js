...
(function () {
  ...
  var SYSTEM_PROMPT = [
    ...
    '⚠️ PROHIBIDO: inventar horas de curso, plazas concretas, nombres de profesores, precios, requisitos técnicos adicionales o cualquier dato no escrito arriba.',
    '',
  ...
  var CSS = [
    ...
    '.feval-msg-bubble ul,.feval-msg-bubble ol{margin:6px 0 8px;padding-left:20px;}',
    '.feval-msg-bubble li{margin-bottom:6px;line-height:1.6;}',
