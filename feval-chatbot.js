...
(function () {
  ...
  var SYSTEM_PROMPT = [
    ...
    '⚠️ DETALLES DE CURSOS: Si el usuario pregunta por temario, contenido, módulos, duración, horas, requisitos previos, nivel, profesor, precio u otros detalles concretos de un curso, y ese dato NO figura textualmente en este prompt → responde EXACTAMENTE: "No tengo el detalle completo de ese curso. Consúltalo en https://formacionfeval.com/index.php/cursos-feval o llama al 924 829 100 / escribe a formacion@feval.com". PROHIBIDO inventar o suponer ese contenido.',
