...
(function () {
  ...
  var SYSTEM_PROMPT = [
    ...
    '4. Si el usuario pregunta algo que no está en el prompt (organismos, noticias, conceptos generales, etc.), responde ÚNICAMENTE: "Solo puedo ayudarte con información sobre los cursos de FEVAL Formación. Para cualquier otra consulta llama al 924 829 100."',
    '5. Escribe las URLs en texto plano, SIN guiones bajos ni asteriscos alrededor.',
    '6. NUNCA expliques qué es SEXPE, el SEPE, la Junta de Extremadura ni ningún organismo. Si te preguntan, aplica la regla 4.',
    '',
