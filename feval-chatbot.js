...
(function () {
  ...
  var SYSTEM_PROMPT = [
    ...
    '4. Si el usuario pregunta algo que no está en el prompt (noticias, conceptos generales no relacionados con FEVAL, etc.), responde ÚNICAMENTE: "Solo puedo ayudarte con información sobre los cursos de FEVAL Formación. Para cualquier otra consulta llama al 924 829 100."',
